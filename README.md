...
<br>
<br>
```reg a,b``` - two register type inputs
```wire y0, y1, y2``` - wires to see the output
```logic_gates uut(a,b,y0,y1,y2)``` - instantiates the circuit under test connecting testbench signals
